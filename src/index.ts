...
const main = async () => {
  // const privateKeyStr =
  //   '1e9b3f1c0077d664322234aa148e1959e8f00728f369001330e39618c9924434552237d2b9367f76bfeebbc9323337fc765fee2e96f3d5ab3f5687462587d621';
  // const privateKeyStr =
  ...
  // const privateKeyStr =
  //   'cafe72799692a0314076b7b3dadfee6347343925ae9dd7f9196cf6c010f0b23dbe0902d6dbcc9e2838164f49e83a5233192b46d8ca459083cf482c4158694428';
  ...
  const bootstrapMultiaddrs: string[] = [
    ...
    // '/ip4/172.235.29.4/tcp/8000/p2p/12D3KooWLxr5ZyjexnnoRupojFrbUM9RYgg6uE4z3tQaJ7y42faG',
    // '/ip4/139.177.187.105/tcp/8000/p2p/12D3KooWNcBboUfDuiGL7tipSa4wYCU8BWftrWPbjivqDiALTiB1',
  ];
  ...
  const node = await createLibp2p({
    ...
    addresses: {
      listen: [
        ...
        // '/ip4/172.232.108.85/tcp/8000',
        // '/ip4/172.235.29.4/tcp/8000',
        // '/ip4/139.177.187.105/tcp/8000',
      ],
    },
...
// TODO:
// try: node.peerStore.get(peerId)? {signal} ??
// Add signal: node.peerRouting.findPeer(peerId /*, { signal }*/)
// Handle error crash node.peerRouting.findPeer()
